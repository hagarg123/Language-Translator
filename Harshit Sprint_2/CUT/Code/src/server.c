/*
*Have two mode 1->login & 2->run...
*User validation in login section..
*It will show new choice to do writetofile,modify,delete.... 
*2-> run ->It will make connection with client...
*After recv() data from client it will call translate function..
*It will return the desired output to client...
*/
